...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/theme-assets/vendors/css/forms/selects/select2.min.css">
  <!-- chartist  CSS-->
  <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/theme-assets/vendors/css/charts/chartist.css">
  <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/theme-assets/vendors/css/charts/chartist-plugin-tooltip.css">
  <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/theme-assets/css/plugins/charts/chartist.min.css">
  <!-- END VENDOR CSS-->
  <!-- BEGIN CHAMELEON  CSS-->
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/theme-assets/css/plugins/forms/wizard.min.css">
  <!-- END Page Level CSS-->
  <!-- BEGIN Custom CSS-->
  <!-- END Custom CSS-->
</head>
<body class="vertical-layout vertical-menu 2-columns   fixed-navbar" data-open="click" data-menu="vertical-menu" data-color="bg-gradient-x-purple-blue" data-col="2-columns">
  ...
  <nav class="header-navbar navbar-expand-md navbar navbar-with-menu navbar-without-dd-arrow fixed-top navbar-semi-light">
            ...
            <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">             <span class="avatar avatar-online"><img src="<?php echo base_url('assets/theme-assets/images/portrait/small/'.$profile->foto); ?>" alt="avatar"><i></i></span></a>
              <div class="dropdown-menu dropdown-menu-right">
                <div class="arrow_box_right"><a class="dropdown-item" href="#"><span class="user-name text-bold-700 text-sm ml-1"><?php echo $profile->fullname ?></span></span></a>
                  <div class="dropdown-divider"></div><a class="dropdown-item" href="<?php echo base_url().'staff/profile' ?>"><i class="ft-user"></i> Profile</a>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow " data-scroll-to-active="true" data-img="<?php echo base_url(); ?>assets/theme-assets/images/backgrounds/08.jpg">
      <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
          <li class="nav-item mr-auto"><a class="navbar-brand" href="<?php echo base_url().'staff/index' ?>"><img class="brand-logo" alt="Chameleon admin logo" src="<?php echo base_url(); ?>assets/theme-assets/images/logo/logo.png"/>
        ...
        <div class="main-menu-content">
          <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            if($this->session->userdata('id_role')=="3"){ ?>
              ...
              <li <?=$this->uri->segment(2) == 'invoice' ? 'class="active"' : ''?> class=" nav-item"><a href="<?php echo base_url().'staff/invoice' ?>"><i class="la la-file-text"></i><span class="menu-title" data-i18n="">Invoice</span></a>
              </li>
              <li <?=$this->uri->segment(2) == 'po' ? 'class="active"' : ''?> class=" nav-item"><a href="<?php echo base_url().'staff/po' ?>"><i class="la la-dropbox"></i><span class="menu-title" data-i18n="">Purchase Order</span></a>
              </li>
              <li <?=$this->uri->segment(2) == 'report' ? 'class="active"' : ''?> class=" nav-item"><a href="<?php echo base_url().'staff/report' ?>"><i class="la la-bar-chart"></i><span class="menu-title" data-i18n="">Report</span></a>
              </li>
            <?php } ?>
            <!-- End Menu staff !-->
          </ul>
