            ...
            <div class="card">
              ...
              <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                  <p class="card-text"></p>
                  <?php echo form_open('staff/reportCOView'); ?>
                  <div class="form-body">
                        ...
                        <div class="form-group col-md-3">
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu col-8 col-md-12" aria-labelledby="dropdownMenuLink">
                              <a class="dropdown-item" href="<?php echo base_url().'staff/reportCashIn' ?>">Cashin</a>
                              ...
                              <a class="dropdown-item" href="<?php echo base_url().'staff/reportLR' ?>">Laba Rugi</a>
