            ...
            <div class="card">
              ...
              <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                  <a class="btn btn-primary btn-sm text-white" href="<?php echo base_url().'staff/tambah_po' ?>"><i class="la la-plus"> Add data</i> </a>
                  <p class="card-text"></p>
                  <div class="table-responsive-sm">
                    <table class="table table-striped table-sm table-bordered zero-configuration">
                      ...
                      <tbody class="text-center">
                        <?php
                        $no = 1;
                        if( ! empty($po)){ // Jika data siswa tidak sama dengan kosong, artinya jika data siswa ada
                          foreach($po as $o){
                            ?>
                            <tr class="text-sm">
                              <td><?php echo date('d/m/Y', strtotime($o->date_po)); ?></td>
                              <td>PO-<?= $o->no_po;?></td>
                              <td><?= $o->fullname?></td>
                              <td><a href="#"><?php echo $o->vendor_name; ?></a></td>
                              <td>Rp <?php echo number_format($o->total_po, 0, '', '.'); ?></td>
                              <td width="1%">
                                <span class="dropdown">
                                ...
                                <span aria-labelledby="btnSearchDrop12" class="dropdown-menu mt-1 dropdown-menu-right">
                                    <a href="<?php echo base_url().'staff/hapus_po/'.$o->no_po; ?>" class="dropdown-item remove">
                                      <i class="ft-trash-2"></i> Delete</a>
                                      <a href="<?php echo base_url().'staff/preview_po/'.$o->no_po; ?>" class="dropdown-item">
                                        <i class="ft-file"></i> Print PO</a>
                                            </span>
                                    </td>
                                  </tr>
                                <?php } ?>
