        ...
        <div class="breadcrumbs-top float-md-right">
          <div class="breadcrumb-wrapper mr-1">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Cash In
              </li>
            </ol>
          </div>
        </div>
            ...
            <div class="card">
              ...
              <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                  <a class="btn btn-primary btn-sm text-white" href="<?php echo base_url().'staff/tambah_cashin' ?>"><i class="la la-plus"> Add data</i> </a>
                  <p class="card-text"></p>
                  <div class="table-responsive-sm">
                    <table class="table table-striped table-sm table-bordered zero-configuration">
                      ...
                      <tbody>
                        <?php
                        if( ! empty($cashin)){ // Jika data siswa tidak sama dengan kosong, artinya jika data siswa ada
                          foreach($cashin as $c){
                            ?>
                            <tr class="text-sm">
                              ...
                              <td><?php if($c->id_invoice != 0){
                                echo $c->no_invoice;
                              } else {
                                echo $c->receipt;
                              }?></td>
                              <td>Rp <?php echo number_format($c->total_cashin, 0, '', '.'); ?></td>
                              <td width="1%">
                                <span class="dropdown">
                                ...
                                <span aria-labelledby="btnSearchDrop12" class="dropdown-menu mt-1 dropdown-menu-right">
                                  <a href="<?php echo base_url().'staff/ubah_cashin/'.$c->no_cashin; ?>" class="dropdown-item">
                                    <i class="ft-edit-2"></i> Edit</a>
                                    <a href="<?php echo base_url().'staff/hapus_cashin/'.$c->no_cashin; ?>" class="dropdown-item remove">
