        ...
        <div class="breadcrumbs-top float-md-right">
          <div class="breadcrumb-wrapper mr-1">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Order Note
              </li>
            </ol>
          </div>
        </div>
          ...
          <div id="invoice-template" class="card-body">
            ...
            <div id="invoice-company-details" class="row">
              ...
              <div class="col-md-6 col-sm-12 text-center text-md-right">
                <h2>Order Note</h2>
                <p># ON - <?= $pesanan->no_order; ?></p>
                <p><?= date('l, d F Y', strtotime($pesanan->date_order));?> </p>
              </div>
            </div>
            <!--/ Invoice Company Details -->
            ...
            <div id="invoice-items-details" class="pt-2">
              ...
              <div class="row">
                <div class="col-md-12 col-sm12 mt-3">
                  <h4>By signing this form, you are deemed to agree and correct the order ordered by the customer listed above.</h4>
                </div>
              </div>
              <div class="row mt-5">
                  ...
                  <div class="row">
                    <div class="col-md-8">
                      <div class="text-center">
                        ...
                        <br><br><br><br><br>
                        <h6></h6>
                        <p>(Nama:_______________________)</p>
                      </div>
                    </div>
                  </div>
                </div>
