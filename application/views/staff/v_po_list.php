      ...
      <div class="content-header-right col-md-8 col-12">
        <div class="breadcrumbs-top float-md-right">
          <div class="breadcrumb-wrapper mr-1">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="<?php echo base_url().'staff/tambah_po' ?>">Back</a>
              </li>
                  ...
                  <div class="table-responsive-sm">
                    <table class="table table-striped table-sm table-bordered zero-configuration">
                      ...
                      <tbody class="text-center">
                        <?php
                        $no = 1;
                        if( ! empty($list_orderpo)){ // Jika data siswa tidak sama dengan kosong, artinya jika data siswa ada
                          foreach($list_orderpo as $l){
                            ?>
                            <tr class="text-sm">
                              <td><?= $no++; ?></td>
                              ...
                              <td width="1%">
                                ...
                                <span aria-labelledby="btnSearchDrop12" class="dropdown-menu mt-1 dropdown-menu-right">
                                    <a href="<?php echo base_url().'staff/hapus_listpo/'.$l->id_dpo; ?>" class="dropdown-item remove">
                          ...
                          <tfoot class="text-center">
                            ...
                            <tr class="text-center borderless">
                              ...
                              <input type="hidden" name="total_po" value="<?= $jumlah; ?>" required>
                            </tr>
                          </tfoot>
                        </table>
                      </div>
                      <div class="form-actions right">
                        <?php if (!empty($list_orderpo)) { ?>
