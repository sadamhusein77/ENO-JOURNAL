        ...
        <div class="breadcrumbs-top float-md-right">
          <div class="breadcrumb-wrapper mr-1">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Staff Profile
              </li>
            </ol>
          </div>
        </div>
          ...
          <div class="card-body">
            ...
            <div class="table-responsive">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                <a href="<?php echo base_url().'staff/ubah_profile/'.$profile->id_user; ?>" class="btn btn-sm btn-warning ml-1" data-toggle="popover" data-content="Edit Profile" data-trigger="hover"><i class="la la-edit"></i></a>
                <a href="<?php echo base_url().'staff/password/'?>" class="btn btn-sm btn-info" data-toggle="popover" data-content="Edit Password" data-trigger="hover"><i class="la la-lock"></i></a>
