            ...
            <div class="card">
              ...
              <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                  ...
                  <p class="card-text"></p>
                  <?php foreach($cashin as $c){ ?>
                  <?php echo form_open('staff/cashin_update'); ?>
                  <form class="form form-horizontal">
                    <div class="form-body">
                      <h4 class="form-section"><i class="la la la-money"></i> <?= $judul?></h4>
                      <input type="hidden" name="no_cashin" value="<?= $c->no_cashin;?>">
                      <div class="row">
                        <div class="col-md-6">
                      ...
                      <div class="row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <select class="select2 form-control" name="receipt" id="id_h5_single" required>
                                <option value="">- Choose Account</option>
                                <option <?php if($c->receipt == "Deposit"){ echo "selected='selected'"; } ?> value="Deposit">Deposit</option>
                                <option <?php if($c->receipt == "WIC"){ echo "selected='selected'"; } ?> value="WIC">Walk in Customer</option>
                                <option <?php if($c->receipt == "Invoice"){ echo "selected='selected'"; } ?> value="Invoice">Invoice</option>
                                <option <?php if($c->receipt == "Other"){ echo "selected='selected'"; } ?> value="Other">Other</option>
                              </select>
                            </div>
                          </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <input type="text" id="userinput3" class="form-control border-primary" placeholder="Input Total Income" name="total" value="<?php echo set_value('total', $c->total_cashin); ?>" required>
                            </div>
                          </div>
