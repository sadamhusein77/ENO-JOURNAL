          ...
          <div id="invoice-template" class="card-body">
            ...
            <div id="invoice-company-details" class="row">
              ...
              <div class="col-md-6 col-sm-12 text-center text-md-right">
                ...
                <p># PO - <?= $pesanan->no_po; ?></p>
                <p><?= date('l, d F Y', strtotime($pesanan->date_po));?> </p>
              </div>
            </div>
            <!--/ Invoice Company Details -->
            ...
            <div id="invoice-customer-details" class="row pt-2">
              <div class="col-md-7 col-sm-12">
                ...
                <p class="text-muted"><a href="#">enocopy23@gmail.com</a></p>
              </div>
              <div class="col-md-5 col-sm-12 text-center text-md-right">
                <p class="text-muted">Order To</p>
                <div class="table-responsive-sm">
                  <tr>
                    <td width="5%"><?= $vendor->vendor_name ?></td>
                  </tr> <br>
                  <tr>
                    <td width="5%"><?= $vendor->vendor_address ?></td>
                  </tr>
                </div>
              </div>
            </div>
                      ...
                      if( ! empty($item)){ // Jika data siswa tidak sama dengan kosong, artinya jika data siswa ada
                        foreach($item as $n){
                          ...
                          <tr>
                            ...
                            <td class="text-right">Rp <?= number_format($n->sub_total, 0, '', '.');?></td>
                          </tr>
                        <?php } ?>
