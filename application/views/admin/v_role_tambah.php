            ...
            <div class="card">
              ...
              <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                  ...
                  <?php echo form_open('admin/role_aksi'); ?>
                  <div class="form-body">
                    <h4 class="form-section">
                      <i class="la la-slack"></i> Role Details</h4>
                      <div class="form-group">
                        <label for="input_kode">Role Code</label>
                        <input class="form-control border-primary" type="text" placeholder="Kode Role" id="input_kode" name="role_code" value="<?php echo set_value('role_code'); ?>" required>
                        <?= form_error('kode_role','<small class="text-danger pl-3">', '</small>'); ?>
                      </div>

                      <div class="form-group">
                        <label for="input_nama">Role Name</label>
                        <input class="form-control border-primary" type="text" placeholder="Nama Role" id="input_nama" name="role_name" value="<?php echo set_value('role_name'); ?>" required>
