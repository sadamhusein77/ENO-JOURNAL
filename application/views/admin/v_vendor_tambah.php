            ...
            <div class="card">
              ...
              <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                  ...
                  <p class="card-text"></p>
                  <?php echo form_open('admin/vendor_aksi'); ?>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-md-9">
                              <input type="text" id="userinput1" class="form-control border-primary" placeholder="Input vendor name" name="vendor_name"  value="<?php echo set_value('vendor_name'); ?>" required>
                            </div>
                          </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-md-9">
                              <input type="text" id="userinput2" class="form-control border-primary" placeholder="Input Telephone / Handphone" name="vendor_telp" value="<?php echo set_value('vendor_telp'); ?>" required>
                            </div>
                          </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-md-9">
                              <textarea id="userinput8" rows="6" class="form-control border-primary" name="vendor_address" placeholder="Input verdor address" required><?php echo set_value('vendor_address'); ?></textarea>
                            </div>
                          </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-md-9">
                              <input type="text" id="userinput4" class="form-control border-primary" placeholder="Input NPWP" name="vendor_npwp" value="<?php echo set_value('vendor_telp'); ?>" required>
                            </div>
                          </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-md-9">
                              <input type="email" id="userinput3" class="form-control border-primary" placeholder="Input Email" name="vendor_email" value="<?php echo set_value('vendor_email'); ?>" required>
                            </div>
                          </div>
