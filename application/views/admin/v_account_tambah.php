            ...
            <div class="card">
              ...
              <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                  ...
                  <p class="card-text"></p>
                  <?php echo form_open('admin/account_aksi'); ?>
                  <div class="form-body">
                    <h4 class="form-section">
                      <i class="ft-clipboard"></i> Account Details</h4>
                      <div class="form-group">
                        <label for="input_code">Account Code</label>
                        <input class="form-control border-primary" type="text" placeholder="Input Account Code" id="input_code" name="account_code" value="<?php echo set_value('account_code'); ?>" required>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="id_class">
                          ...
                          <?php foreach($class as $c){ ?>
                            <option <?php if(set_value('id_class') == $c->id_class){echo "selected='selected'";} ?> value="<?php echo $c->id_class ?>"><?php echo $c->class_name; ?></option>
                          <?php } ?>
                        </select>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input class="form-control border-primary" type="text" placeholder="Input Account Name" id="input_name" name="account_name" value="<?php echo set_value('account_name'); ?>" required>
                      </div>
                      <?= form_error('account_name','<small class="text-danger pl-3">', '</small>'); ?>
                      <div class="form-group row">
                        <div class="form-check ml-2">
                          <input class="form-check-input" type="radio" name="normal_balance" id="id_class1" value="1" checked>
                          <label class="form-check-label" for="id_class1">
                            Debet
                          </label>
                        </div>
                        <div class="form-check ml-5">
                          <input class="form-check-input" type="radio" name="normal_balance" id="id_class2" value="2">
                      ...
                      <div class="form-group">
                        ...
                        <input class="form-control border-primary" type="text" placeholder="Input Balance" id="input_balance" name="balance" value="<?php echo set_value('balance'); ?>" required>
                      </div>
