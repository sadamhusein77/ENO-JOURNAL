            ...
            <div class="card">
              ...
              <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                  ...
                  <p class="card-text"></p>
                  <?php echo form_open('admin/service_aksi'); ?>
                  <div class="form-body">
                    <h4 class="form-section">
                      <i class="ft-clipboard"></i> Service Details</h4>
                      <div class="form-group">
                        <label for="input_name">Service Name</label>
                        <input class="form-control border-primary" type="text" placeholder="Input Service Name" id="input_name" name="service_name" value="<?php echo set_value('service_name'); ?>" required>
                      </div>
                      <?= form_error('service_name','<small class="text-danger pl-3">', '</small>'); ?>
                      <div class="form-group">
                        <label for="input_balance">Price</label>
                        <input class="form-control border-primary" type="text" placeholder="Input Price" id="input_balance" name="price" value="<?php echo set_value('price'); ?>" required>
                      </div>
